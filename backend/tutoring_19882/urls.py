"""tutoring_19882 URL Configuration
...
admin.site.site_header = "Tutoring"
admin.site.site_title = "Tutoring Admin Portal"
admin.site.index_title = "Tutoring Admin"

# swagger
api_info = openapi.Info(
    title="Tutoring API",
    default_version="v1",
    description="API documentation for Tutoring App",
)
